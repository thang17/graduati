...
function BillDetail({ bill, carts, data }) {
//   const arrBill = [];
//   let billMoney = 0;
//   let discountMoney = 0;
//   let totalMoney = 0;
          ...
          <div className={`col-lg-7 ${styles.wrap_col} ${styles.border_right}`}>
            <div>
              ...
              <div className={` ${styles.contact} `}>
                ...
                <ContactItem change content={`Người nhận: Nguyễn Văn A`} type="name" />
                <ContactItem change content={`Số điện thoại: 0123456789`} type="phone" />
                <ContactItem change content={`Ship đến: hồ nam `} type="city" />
              </div>
              <div className={` ${styles.contact} `}>
          ...
          <div className={`col-lg-5 ${styles.wrap_col}`}>
            <div >
              ...
              <div className={styles.money}>
                <Money title="Tạm tính" price={`50000 đ`} />
                <Money title="Giảm giá" price={`60000 đ`} />
                <Money title="Phí vẫn chuyển" className={styles.border_bot} price="Miễn phí" />
                <Money title="Tổng tiền" className={styles.total_money} price={`150000 đ`} />
              </div>
            </div>
          </div>
        </div>
